          ...
          <div className="flex flex-col gap-6 md:flex-1">
            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                <Link
                  href="/contact"
                  className="flex-1 rounded-full bg-[#C8102E] px-6 py-5 text-center text-xl font-bold uppercase text-[#F5A623] transition-colors hover:bg-[#a50d26] whitespace-nowrap"
                >
                  {t("volunteerLink")}
                </Link>
                <Link
