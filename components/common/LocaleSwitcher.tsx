...
export const LocaleSwitcher = () => {
  ...
  return (
    <div className="group relative">
      <button className="flex items-center justify-center rounded-full bg-[#C8102E] px-4 py-2.5 text-lg font-semibold text-[#F5A623] transition-colors hover:bg-[#a50d26]">
