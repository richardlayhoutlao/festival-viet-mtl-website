        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          >
            <Link
              ...
              className="rounded-full bg-[#C8102E] px-4 py-2.5 text-center text-lg font-semibold uppercase text-[#F5A623] transition-colors hover:bg-[#a50d26] whitespace-nowrap"
            >
              {t("applyVolunteer")}
            </Link>
            <Link
